...
public class CrimeListFragment extends Fragment {
    ...
    private class CrimeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            } else if (viewType == R.layout.serious_list_item_crime) {
                return new SeriousCrimeViewHolder(layoutInflater, parent);
            } else {
                return null;
            }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            } else if (holder instanceof SeriousCrimeViewHolder) {
                ((SeriousCrimeViewHolder) holder).bind(crime);
            }
    ...
    private abstract class AbstractCrimeViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public AbstractCrimeViewHolder(LayoutInflater inflater, ViewGroup parent, int layoutId) {
    ...
    private class CrimeViewHolder extends AbstractCrimeViewHolder {
